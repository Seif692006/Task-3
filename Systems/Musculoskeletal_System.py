...
class MusculoskeletalWindow:
    def __init__(self, parent):
        self.window = tk.Toplevel(parent)
        self.window.title("Musculoskeletal System - Human Body Systems Viewer")
        ...
        tk.Label(header, text="💪", font=("Segoe UI Emoji", 36), bg="#2a2a2a", fg="white").pack()
        tk.Label(header, text="Musculoskeletal System", font=("Segoe UI", 16, "bold"),
                 bg="#2a2a2a", fg="white").pack(pady=(10, 0))
        ...
        tk.Label(center, text="💪", font=("Segoe UI Emoji", 64), bg="#1a1a1a", fg="white").pack()
        tk.Label(center, text="Musculoskeletal System Visualization Area",
                 font=("Segoe UI", 24, "bold"), bg="#1a1a1a", fg="white").pack(pady=(20, 10))
        tk.Label(center, text="Content will be displayed here",
                 font=("Segoe UI", 14), bg="#1a1a1a", fg="#888888").pack()

        tk.Label(viz_area, text="Press ESC to return",
                 font=("Segoe UI", 10), bg="#1a1a1a", fg="#555555").pack(side=tk.BOTTOM, pady=20)
