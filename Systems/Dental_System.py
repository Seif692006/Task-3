...
class DentalWindow:
    def __init__(self, parent):
        ...
        self.window.title("Dental System - Human Body Systems Viewer")
        ...
        tk.Label(header, text="Dental System", font=("Segoe UI", 16, "bold"),
        ...
        tk.Label(center, text="Dental System Visualization Area",
