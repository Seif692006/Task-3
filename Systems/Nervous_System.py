...
class NervousWindow:
    def __init__(self, parent):
        ...
        self.window.title("Nervous System - Human Body Systems Viewer")
        ...
        tk.Label(header, text="Nervous System", font=("Segoe UI", 16, "bold"),
        ...
        tk.Label(center, text="Nervous System Visualization Area",
